...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2t49keckhjlsm-ats.iot.ap-southeast-2.amazonaws.com --ca_file root-CA.crt --cert bridge.cert.pem --key bridge.private.key --client_id basicPubSub --topic sdk/test/python --count 0